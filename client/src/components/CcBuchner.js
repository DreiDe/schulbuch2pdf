    ...
    return (
        <div>
            <p className="text-2xl">
                Auf dieser Seite können Sie Schulbücher von Click and Study des C.C. Buchner Verlags als PDF herunterladen. Dies funktioniert allerdings nur wenn sie zuvor eine Lizenz für das eBook beim Verlag selber erworben haben, sodass dieses bei <a href="https://www.click-and-study.de/Buecher" className="underline">click-and-study.de/Buecher</a> gelistet wird.
            </p>
            <br></br>
            <h3>Anleitung:</h3>
            <ol>
                <li>
                    1. Beim Click and Study unter <a href="https://www.click-and-study.de" className="underline">click-and-study.de</a> ganz normal anmelden.
                </li>
                <li>
